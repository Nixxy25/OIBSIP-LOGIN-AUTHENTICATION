                ...
                <div className="flex flex-col w-full gap-10">
                    ...
                    <div className="grid grid-cols-2 gap-6">
                        <div className="flex gap-2 border-2 border-purple-600 p-2 px-4">
                            ...
                            <input className="w-full p-2 outline-none" type="text" placeholder="FirstName"></input>
                        </div>
                        ...
                        <div className="flex gap-2 border-2 border-purple-600 p-2 px-4">
                            ...
                            <input className="w-full p-2 outline-none" type="text" placeholder="LastName"></input>
                        </div>
